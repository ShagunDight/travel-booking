		...
		<div class="container">
			<div class="row g-4 g-lg-5">
				<div class="col-lg-6 position-relative mb-4 mb-md-0">
					<h1 class="mb-4 mt-md-5 display-5">{{ $banner->title }}
				...
				<div class="col-lg-6 position-relative">
					<img src="{{ asset($banner->image) }}" class="rounded" alt="" />
					...
					<div class="vstack gap-5 align-items-center position-absolute top-0 start-0 d-none d-md-flex mt-4 ms-n3">
						<img class="icon-lg shadow-lg border border-3 border-white rounded-circle" src="{{ asset('/images/banner/banner_06.jpg') }}" alt="avatar">
						<img class="icon-xl shadow-lg border border-3 border-white rounded-circle" src="{{ asset('/images/banner/banner_06.jpg') }}" alt="avatar">
					</div>
				</div>
			</div>
			<div class="row">
				<div class="col-xl-10 position-relative mt-n3 mt-xl-n9" >
					...
					<form class="card shadow rounded-3 position-relative p-4 pe-md-5 pb-5 pb-md-4" method="post" action="{{ route('hotel.search') }}">
						@csrf
							...
							<div class="col-lg-4">
								<div class="d-flex">
									...
									<div class="form-control-border form-control-transparent form-fs-md">
										...
										<input type="text" name="date_range" class="form-control flatpickr flatpickr-input" data-mode="range" placeholder="Select date" value="19 Sep to 28 Sep" readonly="readonly">
									</div>
								</div>
							</div>
								...
								<div class="form-control-border form-control-transparent form-fs-md d-flex">
									...
									<div class="w-100">
										...
										<div class="dropdown guest-selector me-2">
											<input type="text" name="guests" class="form-guest-selector form-control selection-result" value="2 Guests 1 Room" data-bs-auto-close="outside" data-bs-toggle="dropdown">
						...
						<div class="btn-position-md-middle">
							<button class="icon-lg btn btn-round btn-primary mb-0" type="submit"><i class="bi bi-search fa-fw"></i></button>
						</div>
					</form>
				</div>
			</div>
	...
	{{-- <section class="pb-2 pb-lg-5">
		<div class="container">
			<div class="tiny-slider arrow-round arrow-blur arrow-hover">
				<div class="tns-outer" id="tns1-ow"><div class="tns-liveregion tns-visually-hidden" aria-live="polite" aria-atomic="true">slide <span class="current">9 to 13</span>  of 4</div><div id="tns1-mw" class="tns-ovh"><div class="tns-inner" id="tns1-iw"><div class="tiny-slider-inner  tns-slider tns-carousel tns-subpixel tns-calc tns-horizontal" data-autoplay="true" data-arrow="true" data-edge="2" data-dots="false" data-items-xl="3" data-items-lg="2" data-items-md="1" id="tns1" style="transform: translate3d(-50%, 0px, 0px);"><div class="tns-item tns-slide-cloned" aria-hidden="true" tabindex="-1">
				...
				<div class="card border rounded-3 overflow-hidden">
					<div class="row g-0 align-items-center">
						...
						<div class="col-sm-6">
							<div class="card-body px-3">
								<h6 class="card-title">
									<a href="offer-detail.html" class="stretched-link">Up to 60% OFF</a>
								</h6>
								<p class="mb-0">On Hotel Bookings Online</p>
							</div>
						</div>
		...
		<div class="container">
			<div class="row g-4 justify-content-between align-items-center">
				<div class="col-lg-5 position-relative">
					...
					<img src="{{ asset('/images/banner/banner_01.jpg') }}" class="rounded-3 position-relative" alt="">
		...
		<div class="container">
			...
			<div class="row g-4">
					...
					<div class="col-sm-6 col-xl-3">
						<div class="card card-img-scale overflow-hidden bg-transparent">
							<div class="card-img-scale-wrapper rounded-3">
								<img src="{{ asset($value->property_image[0]->url) }}" class="card-img" alt="hotel image">
								<div class="position-absolute bottom-0 start-0 p-3">
									<div class="badge text-bg-dark fs-6 rounded-pill stretched-link"><i class="bi bi-geo-alt me-2"></i>{{ $value->city->name }}</div>
								</div>
							</div>
							<div class="card-body px-2">
								<h5 class="card-title">
									<a href="{{ route('hotels.property_detail', $value->id) }}" class="stretched-link">{{ $value->name }}</a>
								</h5>
								<div class="d-flex justify-content-between align-items-center">
									<h6 class="text-success mb-0"><i class="fa fa-inr"></i>{{ $value->minRoomPrice->price_per_night }}<small class="fw-light">/starting at</small> </h6>
									<h6 class="mb-0">{{ $value->rating_avg }}<i class="fa-solid fa-star text-warning ms-1"></i></h6>
								</div>
							</div>
						</div>
					</div>
				...
				<div class="col-sm-6 col-xl-3">
					<div class="card card-img-scale overflow-hidden bg-transparent">
						<div class="card-img-scale-wrapper rounded-3">
							<img src="https://picsum.photos/800/500?1" class="card-img" alt="hotel image">
							<div class="position-absolute bottom-0 start-0 p-3">
						...
						<div class="card-body px-2">
							<h5 class="card-title">
								<a href="hotel-detail.html" class="stretched-link">New Apollo Hotel</a>
							</h5>
							<div class="d-flex justify-content-between align-items-center">
								<h6 class="text-success mb-0"><i class="fa fa-inr"></i>585 <small class="fw-light">/starting at</small> </h6>
				...
				<div class="col-sm-6 col-xl-3">
					<div class="card card-img-scale overflow-hidden bg-transparent">
						...
						<div class="card-body px-2">
							<h5 class="card-title">
								<a href="hotel-detail.html" class="stretched-link">New Age Hotel</a>
							</h5>
							<div class="d-flex justify-content-between align-items-center">
								<h6 class="text-success mb-0"><i class="fa fa-inr"></i>385 <small class="fw-light">/starting at</small> </h6>
				...
				<div class="col-sm-6 col-xl-3">
					<div class="card card-img-scale overflow-hidden bg-transparent">
						...
						<div class="card-body px-2">
							<h5 class="card-title">
								<a href="hotel-detail.html" class="stretched-link">Helios Beach Resort</a>
							</h5>
							<div class="d-flex justify-content-between align-items-center">
								<h6 class="text-success mb-0"><i class="fa fa-inr"></i>665 <small class="fw-light">/starting at</small> </h6>
								<h6 class="mb-0">4.8<i class="fa-solid fa-star text-warning ms-1"></i></h6>
							</div>
						</div>
					</div>
			...
			<div class="row">
				<div class="col-lg-11 mx-auto">
					<div class="tiny-slider arrow-round arrow-border arrow-hover">
						<div class="tns-outer" id="tns2-ow"><div class="tns-liveregion tns-visually-hidden" aria-live="polite" aria-atomic="true">slide <span class="current">5 to 7</span>  of 2</div><div id="tns2-mw" class="tns-ovh"><div class="tns-inner" id="tns2-iw"><div class="tiny-slider-inner  tns-slider tns-carousel tns-subpixel tns-calc tns-horizontal" data-edge="2" data-items="1" id="tns2" style="transform: translate3d(-62.5%, 0px, 0px);"><div class="px-4 px-md-5 tns-item tns-slide-cloned" aria-hidden="true" tabindex="-1">
								<div class="row justify-content-between align-items-center">
									<div class="col-md-6 col-lg-5 position-relative">
										<div class="position-absolute top-0 start-0 translate-middle mt-7 ms-4 z-index-9">
											<img src="https://stackbros.in/bookinga/landing/assets/images/element/03.svg" class="h-60px bg-orange p-2 rounded" alt="">
										</div>
										...
										<img src="https://stackbros.in/bookinga/landing/assets/images/team/02.jpg" class="rounded-3 position-relative" alt="">
									</div>
							...
							<div class="px-4 px-md-5 tns-item tns-slide-cloned" aria-hidden="true" tabindex="-1">
								<div class="row justify-content-between align-items-center">
									<div class="col-md-6 col-lg-5 position-relative">
										<div class="position-absolute top-0 start-0 translate-middle z-index-9 mt-7 ms-4">
											<img src="https://stackbros.in/bookinga/landing/assets/images/element/02.svg" class="h-60px bg-orange rounded p-2" alt="">
										</div>
										...
										<img src="https://stackbros.in/bookinga/landing/assets/images/team/01.jpg" class="rounded-3 position-relative" alt="">
									</div>
