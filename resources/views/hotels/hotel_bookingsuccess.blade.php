                                ...
                                <div class="col-lg-5">
                                    <ul class="list-group list-group-borderless">
                                        ...
                                        <li class="list-group-item d-sm-flex justify-content-between align-items-center">
                                            ...
                                            <span class="h6 fw-normal mb-0">{{ \Carbon\Carbon::parse($hotel->check_in)->format('d M Y') }}</span>
                                        </li>
                                        <li class="list-group-item d-sm-flex justify-content-between align-items-center">
                                            <span class="mb-0"><i class="bi bi-calendar fa-fw me-2"></i>Check-out:</span>
                                            <span class="h6 fw-normal mb-0">{{ \Carbon\Carbon::parse($hotel->check_out)->format('d M Y') }}</span>
                                        </li>
                                        <li class="list-group-item d-sm-flex justify-content-between align-items-center">
