		...
		<div class="container">
			...
			<div class="navbar-collapse collapse" id="navbarCategoryCollapse">
				<ul class="navbar-nav navbar-nav-scroll nav-pills-primary-soft text-center ms-auto p-2 p-xl-0">
					<li class="nav-item">
						<a class="nav-link {{ request()->is('hotels') ? 'active' : '' }}" href="{{ url('/hotels') }}"><i class="fa-solid fa-hotel me-2"></i>Hotel</a>
					</li>
					<li class="nav-item">
						<a class="nav-link {{ request()->is('tours') ? 'active' : '' }}" href="{{ url('/tours') }}"><i class="fa-solid fa-globe-americas me-2"></i>Tour</a>
					</li>
					@guest
                        <li class="nav-item">
                            <a class="nav-link {{ request()->is('login') ? 'active' : '' }}" href="{{ url('/login') }}">
                                <i class="fa-solid fa-power me-2"></i>Sign-In
                            </a>
                        </li>
                    @endguest
			...
			<ul class="nav flex-row align-items-center list-unstyled ms-xl-auto">
				<li class="nav-item ms-3 dropdown">
					<a class="avatar avatar-sm p-0" href="#" id="profileDropdown" role="button" data-bs-auto-close="outside" data-bs-display="static" data-bs-toggle="dropdown" aria-expanded="false">
						<img class="avatar-img rounded-2" src="https://www.pngkey.com/png/full/73-730434_04-dummy-avatar.png" alt="avatar">
					</a>
					<ul class="dropdown-menu dropdown-animation dropdown-menu-end shadow pt-3" aria-labelledby="profileDropdown">
						<li class="px-3 mb-3">
							<div class="d-flex align-items-center">
								<div class="avatar me-3">
									<img class="avatar-img rounded-circle shadow" src="https://www.pngkey.com/png/full/73-730434_04-dummy-avatar.png" alt="avatar">
								</div>
								<div>
						...
						@auth
						<li>
							<a href="#" class="dropdown-item bg-danger-soft-hover"
								onclick="event.preventDefault(); event.stopPropagation(); document.getElementById('logoutForm').submit();">
